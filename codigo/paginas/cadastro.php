   ...
   <body>
     ...
     <div class="mdl-layout mdl-js-layout mdl-layout--fixed-header
      ...
      <div class="mdl-layout__tab-bar mdl-js-ripple-effect">
        <a href="#pess" class="mdl-layout__tab is-active">Informações Pessoais</a>
...
<div class="demo-ribbon mdl-color--yellow"></div>
 ...
 <section class="mdl-layout__tab-panel is-active" id="pess">
      <div class="mdl-grid">
      <div class="mdl-cell mdl-cell--2-col"></div>
          <div class="demo-content mdl-cell mdl-cell--8-col mdl-shadow--4dp mdl-color--white">
              ...
              <form action="../bd/crudaluno.php" method="post" name="editar">
                  <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label mdl-cell mdl-cell--10-col">
                    <input class="mdl-textfield__input" type="text" id="nome" name="nome" value="<?php echo $lista['nome'];?>">
